...
function resize() {
    ...
    function resizeCanvas() {
        htmlCanvas.width = document.getElementById('canvas1').clientWidth;
        htmlCanvas.height = document.getElementById('canvas1').clientHeight;
        redraw();
    }
